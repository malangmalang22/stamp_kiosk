...
public class MainActivity extends AppCompatActivity  implements BeaconConsumer {
    ...
    public void onBeaconServiceConnect() {
        ...
        try {
            ...
            beaconManager.startRangingBeaconsInRegion(new Region("20:4E:F6:C1:F8:A4", null, null, null));
        } catch (RemoteException e) {    }
    }
    public void onclicked1(View v) {
        Toast.makeText(this, "스캔.", Toast.LENGTH_SHORT).show();
        onBeaconServiceConnect();

    }

    public void onclicked2(View v) {
        Toast.makeText(this, "스탑.", Toast.LENGTH_SHORT).show();
